...
if __name__ == "__main__":
    ...
    # get db session
    session = get_session()
    # find MBDTF, a 10 review from pitchfork
    review_text = session.query(Content).filter(Content.reviewid == 14880).first().content
    print(sentiment(classifier, review_text))
